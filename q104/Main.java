...
public class Main {
	public static void main(String[] args) {
		...
		*/
		...
		// 검색
		System.out.println("\n-위치 검색-");
		if (list.indexOf("하후돈") > -1) {
			System.out.println(list.lastIndexOf("하후돈"));
		} else {
			System.out.println("하후돈 없음");
		}
		
		// 검색
		System.out.println(list.lastIndexOf("허허허"));
		System.out.println(list.indexOf("허허허", 3));
		System.out.println(list.contains("허허허"));
